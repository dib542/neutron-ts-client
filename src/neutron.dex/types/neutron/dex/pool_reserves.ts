...
function createBasePoolReservesKey(): PoolReservesKey {
  return { tradePairId: undefined, tickIndexTakerToMaker: 0, fee: 0 };
}
...
export const PoolReservesKey = {
  ...
  toJSON(message: PoolReservesKey): unknown {
    const obj: any = {};
...
function createBasePoolReserves(): PoolReserves {
  return { key: undefined, reservesMakerDenom: "", priceTakerToMaker: "", priceOppositeTakerToMaker: "" };
}
...
export const PoolReserves = {
  ...
  fromJSON(object: any): PoolReserves {
    return {
      ...
      priceOppositeTakerToMaker: isSet(object.priceOppositeTakerToMaker)
        ? String(object.priceOppositeTakerToMaker)
        : "",
    };
  },

  toJSON(message: PoolReserves): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<PoolReserves>, I>>(object: I): PoolReserves {
    ...
    message.key = (object.key !== undefined && object.key !== null)
      ? PoolReservesKey.fromPartial(object.key)
      : undefined;
