...
export const MsgSubmitProposalLegacy = {
  encode(message: MsgSubmitProposalLegacy, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSubmitProposalLegacy {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: MsgSubmitProposalLegacy): unknown {
    const obj: any = {};
...
export const MsgSubmitProposalLegacyResponse = {
  encode(message: MsgSubmitProposalLegacyResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSubmitProposalLegacyResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  toJSON(message: MsgSubmitProposalLegacyResponse): unknown {
    const obj: any = {};
...
export class MsgClientImpl implements Msg {
  ...
  SubmitProposalLegacy(request: MsgSubmitProposalLegacy): Promise<MsgSubmitProposalLegacyResponse> {
    ...
    return promise.then((data) => MsgSubmitProposalLegacyResponse.decode(new _m0.Reader(data)));
  }
}
